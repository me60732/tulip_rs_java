...
/**
 * APO (Average Price Oscillator) — Java facade over the {@code apo_*}
...
public final class Apo {
    ...
    /** FNV-1a32("apo") == C_INDICATOR_ID_APO from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x366aa761L;

    static final Native NATIVE = new Native("apo", ID, INPUTS, OPTIONS);
