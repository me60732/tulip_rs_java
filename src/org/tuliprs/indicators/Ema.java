...
/**
 * EMA (Exponential Moving Average) — Java facade over the {@code ema_*}
...
public final class Ema {
    ...
    /** FNV-1a32("ema") == C_INDICATOR_ID_EMA from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x7f8ac522L;

    static final Native NATIVE = new Native("ema", ID, INPUTS, OPTIONS);
