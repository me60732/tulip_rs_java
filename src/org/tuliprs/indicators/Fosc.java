...
/**
 * FOSC (Fractal Oscillator) — Java facade over the {@code fosc_*}
...
public final class Fosc {
    ...
    /** FNV-1a32("fosc") == C_INDICATOR_ID_FOSC from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x165ac3c0L;

    static final Native NATIVE = new Native("fosc", ID, INPUTS, OPTIONS);
     ...
     * outputs in fixed order: tsf, linreg, linregslope, linregintercept.
     */
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional outputs (tsf, linreg, linregslope, linregintercept). */
    ...
    /** As {@link #simdByOptions(double[], double[][])} plus optional outputs (tsf, linreg, linregslope, linregintercept). */
