...
/**
 * VHF (Vertical Horizontal Filter) — Java facade over the {@code vhf_*}
...
public final class Vhf {
    ...
    /** FNV-1a32("vhf") == C_INDICATOR_ID_VHF from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x9014a80fL;

    static final Native NATIVE = new Native("vhf", ID, INPUTS, OPTIONS);
     ...
     * outputs in fixed order: short_sma, long_sma, short_stddev, long_stddev.
     */
