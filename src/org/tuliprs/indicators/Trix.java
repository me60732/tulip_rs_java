...
/**
 * TRIX (Triple Exponential Average) — Java facade over the {@code trix_*}
...
public final class Trix {
    ...
    /** FNV-1a32("trix") == C_INDICATOR_ID_TRIX from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x68942752L;

    static final Native NATIVE = new Native("trix", ID, INPUTS, OPTIONS);
     ...
     * outputs in fixed order: tema, dema, ema.
     */
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional outputs (tema, dema, ema). */
