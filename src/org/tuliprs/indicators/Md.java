...
/**
 * MD (Mean Deviation) — Java facade over the {@code md_*}
...
public final class Md {
    ...
    /** FNV-1a32("md") == C_INDICATOR_ID_MD from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x672e2914L;

    static final Native NATIVE = new Native("md", ID, INPUTS, OPTIONS);
