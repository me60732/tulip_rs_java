...
/**
 * MSW (Moving Slope Weighted) — Java facade over the {@code msw_*}
...
public final class Msw {
    ...
    /** Number of input series: close. */
    public static final int INPUTS = 1;

    /** Number of options: period. */
    public static final int OPTIONS = 1;

    /** FNV-1a32("msw") == C_INDICATOR_ID_MSW from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xd08045d2L;

    static final Native NATIVE = new Native("msw", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs MSW over the given bars.
     *
     * @param inputs  {close}, of equal length
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional outputs (none for MSW). */
    ...
    /** As {@link #simdByOptions(double[], double[][])} plus optional outputs (none for MSW). */
