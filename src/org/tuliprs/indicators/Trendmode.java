...
/**
 * TRENDMODE (Trend Mode) — Java facade over the {@code trendmode_*}
...
public final class Trendmode {
    ...
    /** FNV-1a32("trendmode") == C_INDICATOR_ID_TRENDMODE from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xfbbbad43L;

    static final Native NATIVE = new Native("trendmode", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs TRENDMODE over the given bars.
     *
     ...
     * outputs in fixed order: cycle, peak.
     */
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional outputs (cycle, peak). */
