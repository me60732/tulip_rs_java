...
/**
 * CVI (Chaikin Volatility Index) — Java facade over the {@code cvi_*}
...
public final class Cvi {
    ...
    /** FNV-1a32("cvi") == C_INDICATOR_ID_CVI from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xf14f6a1fL;

    static final Native NATIVE = new Native("cvi", ID, INPUTS, OPTIONS);
