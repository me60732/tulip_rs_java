...
/**
 * Cybercycle — Java facade over the {@code cybercycle_*}
...
public final class Cybercycle {
    ...
    /** FNV-1a32("cybercycle") == C_INDICATOR_ID_CYBERCYCLE from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x270c53fcL;

    static final Native NATIVE = new Native("cybercycle", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Cybercycle over the given bars.
     *
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional outputs: trigger_line. */
    ...
    /** As {@link #simdByOptions(double[], double[][])} plus optional outputs: trigger_line. */
