...
/**
 * ULTOSC (Ultimate Oscillator) — Java facade over the {@code ultosc_*}
...
public final class Ultosc {
    ...
    /** Number of options: short_period, medium_period, long_period. */
    public static final int OPTIONS = 3;

    /** FNV-1a32("ultosc") == C_INDICATOR_ID_ULTOSC from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x13ab054bL;

    static final Native NATIVE = new Native("ultosc", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs ULTOSC over the given bars.
     *
     * @param inputs  {high, low, close}, each of equal length
     * @param options {short_period, medium_period, long_period}
     */
