...
/**
 * DPO (Detrended Price Oscillator) — Java facade over the {@code dpo_*}
...
public final class Dpo {
    ...
    /** FNV-1a32("dpo") == C_INDICATOR_ID_DPO from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xee2a60e2L;

    static final Native NATIVE = new Native("dpo", ID, INPUTS, OPTIONS);
