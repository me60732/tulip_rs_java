...
/**
 * Hma (Hull Moving Average) — Java facade over the {@code hma_*}
...
public final class Hma {
    ...
    /** FNV-1a32("hma") == C_INDICATOR_ID_HMA from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xf7c819fdL;

    static final Native NATIVE = new Native("hma", ID, INPUTS, OPTIONS);
