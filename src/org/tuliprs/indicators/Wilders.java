...
/**
 * WILDERS (Wilder's smoothing/EMA) — Java facade over the {@code wilders_*}
...
public final class Wilders {
    ...
    /** FNV-1a32("wilders") == C_INDICATOR_ID_WILDERS from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xccdd160fL;

    static final Native NATIVE = new Native("wilders", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs WILDERS over the given bars.
     *
