...
/**
 * VWMA (Volume Weighted Moving Average) — Java facade over the {@code vwma_*}
 ...
 */
public final class Vwma {

    private Vwma() {}

    /** Number of input series: real, volume. */
    public static final int INPUTS = 2;

    /** Number of options: period. */
    public static final int OPTIONS = 1;

    /** FNV-1a32("vwma") == C_INDICATOR_ID_VWMA from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xa27615dcL;

    static final Native NATIVE = new Native("vwma", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs VWMA over the given bars.
     *
     * @param inputs  {real, volume}, each of equal length
    ...
    /** As {@link #simdByOptions(double[][], double[][])} (no optional outputs). */
