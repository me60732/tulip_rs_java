...
/**
 * QStick — Java facade over the {@code qstick_*}
 ...
 */
public final class Qstick {

    private Qstick() {}

    /** Number of input series: open, close. */
    public static final int INPUTS = 2;

    /** Number of options: period. */
    public static final int OPTIONS = 1;

    /** FNV-1a32("qstick") == C_INDICATOR_ID_QSTICK from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x1317555cL;

    static final Native NATIVE = new Native("qstick", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs QStick over the given bars.
     *
     * @param inputs  {open, close}, each of equal length
