...
/**
 * PPO (Percentage Price Oscillator) — Java facade over the {@code ppo_*}
...
public final class Ppo {
    ...
    /** Number of options: fast_period, slow_period. */
    public static final int OPTIONS = 2;

    /** FNV-1a32("ppo") == C_INDICATOR_ID_PPO from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x507f3e86L;

    static final Native NATIVE = new Native("ppo", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs PPO over the given bars.
     *
     * @param inputs  {real}, each of equal length
     * @param options {fast_period, slow_period}
     */
