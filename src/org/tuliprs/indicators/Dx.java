...
/**
 * DX (Directional Index) — Java facade over the {@code dx_*}
...
public final class Dx {
    ...
    /** FNV-1a32("dx") == C_INDICATOR_ID_DX from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x511cbd51L;

    static final Native NATIVE = new Native("dx", ID, INPUTS, OPTIONS);
