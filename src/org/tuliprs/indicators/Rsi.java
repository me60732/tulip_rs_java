...
/**
 * RSI (Relative Strength Index) — Java facade over the {@code rsi_*}
...
public final class Rsi {
    ...
    /** FNV-1a32("rsi") == C_INDICATOR_ID_RSI from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x49dc8a21L;

    static final Native NATIVE = new Native("rsi", ID, INPUTS, OPTIONS);
