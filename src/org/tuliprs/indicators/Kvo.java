...
/**
 * Kvo — Java facade over the {@code kvo_*} tulip_rs_ffi symbols.
...
public final class Kvo {
    ...
    /** FNV-1a32("kvo") == C_INDICATOR_ID_KVO from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x76363221L;

    static final Native NATIVE = new Native("kvo", ID, INPUTS, OPTIONS);
     ...
     * outputs in fixed order: short_ema, long_ema.
     */
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional outputs (short_ema, long_ema). */
    ...
    /** As {@link #simdByOptions(double[], double[][])} plus optional outputs (short_ema, long_ema). */
