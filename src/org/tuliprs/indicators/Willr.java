...
/**
 * WILLR (Williams %R) — Java facade over the {@code willr_*}
...
public final class Willr {
    ...
    /** FNV-1a32("willr") == C_INDICATOR_ID_WILLR from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x48dd286dL;

    static final Native NATIVE = new Native("willr", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs WILLR over the given bars.
     *
     ...
     * outputs in fixed order: min, max.
     */
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional outputs (min, max). */
