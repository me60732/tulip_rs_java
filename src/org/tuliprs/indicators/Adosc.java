...
/**
 * ADOSC (Accumulation/Distribution Oscillator) — Java facade over the {@code adosc_*}
...
public final class Adosc {
    ...
    /** FNV-1a32("adosc") == C_INDICATOR_ID_ADOSC from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x563a9e3L;

    static final Native NATIVE = new Native("adosc", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs ADOSC over the given bars.
     *
