...
/**
 * Mass Index — Java facade over the {@code mass_*} tulip_rs_ffi symbols.
...
public final class Mass {
    ...
    /** FNV-1a32("mass") == C_INDICATOR_ID_MASS from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xdf7738d1L;

    static final Native NATIVE = new Native("mass", ID, INPUTS, OPTIONS);
    ...
    /** As {@link #indicator(double[][], double[])} but also computing optional outputs. */
