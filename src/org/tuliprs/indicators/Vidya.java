...
/**
 * VIDYA (Variable Index Dynamic Average) — Java facade over the {@code vidya_*}
...
public final class Vidya {
    ...
    /** Number of options: short_period, long_period, alpha. */
    public static final int OPTIONS = 3;

    /** FNV-1a32("vidya") == C_INDICATOR_ID_VIDYA from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xdd15a38aL;

    static final Native NATIVE = new Native("vidya", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs VIDYA over the given bars.
     *
     * @param inputs  {real}, each of equal length
     * @param options {short_period, long_period, alpha}
     */
     ...
     * outputs in fixed order: short_ema, long_ema, sma.
     */
