...
/**
 * MACD (Moving Average Convergence Divergence) — Java facade over the {@code macd_*}
...
public final class Macd {
    ...
    /** Number of options: fastperiod, slowperiod, signalperiod. */
    public static final int OPTIONS = 3;

    /** FNV-1a32("macd") == C_INDICATOR_ID_MACD from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xd09fc3a4L;

    static final Native NATIVE = new Native("macd", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs MACD over the given bars.
     *
     * @param inputs  {real}, each of equal length
     * @param options {fastperiod, slowperiod, signalperiod}
     */
