...
/**
 * MOM (Momentum) — Java facade over the {@code mom_*}
...
public final class Mom {
    ...
    /** FNV-1a32("mom") == C_INDICATOR_ID_MOM from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xe69e7d88L;

    static final Native NATIVE = new Native("mom", ID, INPUTS, OPTIONS);
