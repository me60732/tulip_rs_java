...
/**
 * Linreg — Java facade over the {@code linreg_*} tulip_rs_ffi symbols.
...
public final class Linreg {
    ...
    /** FNV-1a32("linreg") == C_INDICATOR_ID_LINREG from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xafe110d2L;

    static final Native NATIVE = new Native("linreg", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Linear Regression over the given bars.
     *
