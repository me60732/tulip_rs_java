...
/**
 * Stochastic RSI — Java facade over the {@code stochrsi_*} tulip_rs_ffi symbols.
...
public final class Stochrsi {
    ...
    /** Number of input series: real (close). */
    public static final int INPUTS = 1;

    /** Number of options: period. */
    public static final int OPTIONS = 1;

    /** FNV-1a32("stochrsi") == C_INDICATOR_ID_STOCHRSI from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x79c7cb36L;

    static final Native NATIVE = new Native("stochrsi", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Stochastic RSI over the given bars.
     *
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional outputs (signal). */
