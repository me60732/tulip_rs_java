...
/**
 * MAX (Maximum) — Java facade over the {@code max_*} tulip_rs_ffi symbols.
...
public final class Max {
    ...
    /** FNV-1a32("max") == C_INDICATOR_ID_MAX from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xd7a2e319L;

    static final Native NATIVE = new Native("max", ID, INPUTS, OPTIONS);
     ...
     * outputs. MAX has no optional outputs.
     */
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional outputs (none for MAX). */
    ...
    /** As {@link #simdByOptions(double[][], double[][])} plus optional outputs (none for MAX). */
