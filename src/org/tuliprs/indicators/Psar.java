...
/**
 * PSAR (Parabolic SAR) — Java facade over the {@code psar_*}
...
public final class Psar {
    ...
    /** Number of options: acceleration_factor, maximum. */
    public static final int OPTIONS = 2;

    /** FNV-1a32("psar") == C_INDICATOR_ID_PSAR from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x78f68ce7L;

    static final Native NATIVE = new Native("psar", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs PSAR over the given bars.
     *
     * @param inputs  {high, low}, each of equal length
     * @param options {acceleration_factor, maximum}
     */
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional output (ep). */
    ...
    /** As {@link #simdByOptions(double[], double[][])} plus optional output. */
