...
/**
 * DM (Directional Movement) — Java facade over the {@code dm_*}
...
public final class Dm {
    ...
    /** FNV-1a32("dm") == C_INDICATOR_ID_DM from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x641cdb3aL;

    static final Native NATIVE = new Native("dm", ID, INPUTS, OPTIONS);
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional outputs (+dm, -dm). */
