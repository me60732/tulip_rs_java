...
/**
 * VOSC (Volume Oscillator) — Java facade over the {@code vosc_*} tulip_rs_ffi
 * symbols. All work happens in the shared {@link Native} engine; this class is
 * just the indicator's constants plus delegation.
 *
 ...
 */
public final class Vosc {

    private Vosc() {}

    /** Number of input series: volume. */
    public static final int INPUTS = 1;

    /** Number of options: short_period, long_period. */
    public static final int OPTIONS = 2;

    /** FNV-1a32("vosc") == C_INDICATOR_ID_VOSC from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x6574f8b0L;

    static final Native NATIVE = new Native("vosc", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs VOSC over the given bars.
     *
     * @param inputs  {volume}, each of equal length
     * @param options {short_period, long_period}
     */
     ...
     * outputs in fixed order: short_sma, long_sma.
     */
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional outputs (short_sma, long_sma). */
