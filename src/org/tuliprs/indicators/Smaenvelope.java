...
/**
 * SMAEnvelope — Java facade over the {@code smaenvelope_*}
 ...
 */
public final class Smaenvelope {
    ...
    /** Number of options: period, percentage. */
    public static final int OPTIONS = 2;

    /** FNV-1a32("smaenvelope") == C_INDICATOR_ID_SMAENVELOPE from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xf630ea08L;

    static final Native NATIVE = new Native("smaenvelope", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs SMA Envelope over the given bars.
     *
     * @param inputs  {real}, each of equal length
     * @param options {period, percentage}
     */
