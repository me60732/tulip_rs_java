...
/**
 * Marketfi (Market Force Index) — Java facade over the {@code marketfi_*}
 ...
 */
public final class Marketfi {

    private Marketfi() {}

    /** Number of input series: high, low, volume. */
    public static final int INPUTS = 3;

    /** Number of options: none. */
    public static final int OPTIONS = 0;

    /** FNV-1a32("marketfi") == C_INDICATOR_ID_MARKETFI from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xd5f01ad4L;

    static final Native NATIVE = new Native("marketfi", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Marketfi over the given bars.
     *
     * @param inputs  {high, low, volume}, each of equal length
     * @param options {} (none)
     */
