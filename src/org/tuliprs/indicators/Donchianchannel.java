...
/**
 * Donchianchannel — Java facade over the {@code donchianchannel_*}
 ...
 */
public final class Donchianchannel {
    ...
    /** FNV-1a32("donchianchannel") == C_INDICATOR_ID_DONCHIANCHANNEL from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x6f5a52f2L;

    static final Native NATIVE = new Native("donchianchannel", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Donchianchannel over the given bars.
     *
     ...
     * outputs in fixed order: upper, lower.
     */
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional outputs (upper, lower). */
