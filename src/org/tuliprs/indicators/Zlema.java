...
/**
 * ZLEMA (Zero-Lag Moving Average) — Java facade over the {@code zlema_*}
...
public final class Zlema {
    ...
    /** FNV-1a32("zlema") == C_INDICATOR_ID_ZLEMA from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xdb860ed4L;

    static final Native NATIVE = new Native("zlema", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs ZLEMA over the given bars.
     *
