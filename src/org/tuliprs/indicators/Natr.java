...
/**
 * NATR (Normalized Average True Range) — Java facade over the {@code natr_*}
...
public final class Natr {
    ...
    /** FNV-1a32("natr") == C_INDICATOR_ID_NATR from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xadfb891aL;

    static final Native NATIVE = new Native("natr", ID, INPUTS, OPTIONS);
