...
/**
 * EMV (Ease of Movement) — Java facade over the {@code emv_*}
...
public final class Emv {
    ...
    /** Number of options: no options. */
    public static final int OPTIONS = 0;

    /** FNV-1a32("emv") == C_INDICATOR_ID_EMV from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x6a8aa413L;

    static final Native NATIVE = new Native("emv", ID, INPUTS, OPTIONS);
