...
/**
 * CHANDELIEREXIT (Chandelier Exit) — Java facade over the {@code chandelierexit_*}
 ...
 */
public final class Chandelierexit {

    private Chandelierexit() {}

    /** Number of input series: high, low, close. */
    public static final int INPUTS = 3;

    /** Number of options: period, multiplier. */
    public static final int OPTIONS = 2;

    /** FNV-1a32("chandelierexit") == C_INDICATOR_ID_CHANDELIEREXIT from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x6dd369deL;

    static final Native NATIVE = new Native("chandelierexit", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs CHANDELIEREXIT over the given bars.
     *
     * @param inputs  {high, low, close}, each of equal length
     * @param options {period, multiplier}
     */
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional outputs (high_sum, low_sum, atr). */
    ...
    /** As {@link #simdByOptions(double[], double[][])} plus optional outputs (high_sum, low_sum, atr). */
