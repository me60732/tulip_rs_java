...
/**
 * Ichimoku — Java facade over the {@code ichimoku_*} tulip_rs_ffi symbols.
...
public final class Ichimoku {
    ...
    /** FNV-1a32("ichimoku") == C_INDICATOR_ID_ICHIMOKU from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x2efb4f1eL;

    static final Native NATIVE = new Native("ichimoku", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Ichimoku over the given bars.
     *
     ...
     * outputs in fixed order: lagging_span.
     */
    ...
    /** As {@link #simdByOptions(double[][], double[][])} plus optional outputs (lagging_span). */
