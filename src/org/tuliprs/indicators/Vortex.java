...
/**
 * Vortex (VORTEX) — Java facade over the {@code vortex_*} tulip_rs_ffi symbols.
...
public final class Vortex {
    ...
    /** FNV-1a32("vortex") == C_INDICATOR_ID_VORTEX from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xd8760e19L;

    static final Native NATIVE = new Native("vortex", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs VORTEX over the given bars.
     *
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional outputs (tr). */
