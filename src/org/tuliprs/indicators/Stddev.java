...
/**
 * Stddev (Standard Deviation) — Java facade over the {@code stddev_*}
...
public final class Stddev {
    ...
    /** FNV-1a32("stddev") == C_INDICATOR_ID_STDDEV from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x41229629L;

    static final Native NATIVE = new Native("stddev", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Stddev over the given bars.
     *
