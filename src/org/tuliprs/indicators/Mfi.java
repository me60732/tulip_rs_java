...
/**
 * MFI (Money Flow Index) — Java facade over the {@code mfi_*}
...
public final class Mfi {
    ...
    /** FNV-1a32("mfi") == C_INDICATOR_ID_MFI from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xe6afc6a9L;

    static final Native NATIVE = new Native("mfi", ID, INPUTS, OPTIONS);
