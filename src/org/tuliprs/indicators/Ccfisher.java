...
/**
 * CCFISHER (Cyber Cycle Fisher) — Java facade over the {@code ccfisher_*}
...
public final class Ccfisher {
    ...
    /** Number of options: alpha. */
    public static final int OPTIONS = 1;

    /** FNV-1a32("ccfisher") == C_INDICATOR_ID_CCFISHER from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x9a6bedaaL;

    static final Native NATIVE = new Native("ccfisher", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs CCFISHER over the given bars.
     *
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional outputs (trendmode, cycle, peak). */
    ...
    /** As {@link #simdByOptions(double[][], double[][])} plus optional outputs (trendmode, cycle, peak). */
