...
/**
 * AROON (Aroon) — Java facade over the {@code aroon_*}
...
public final class Aroon {
    ...
    /** FNV-1a32("aroon") == C_INDICATOR_ID_AROON from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x2e9284aL;

    static final Native NATIVE = new Native("aroon", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs AROON over the given bars.
     *
