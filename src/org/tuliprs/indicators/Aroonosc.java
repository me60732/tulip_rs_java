...
/**
 * AROONOSC (Aroon Oscillator) — Java facade over the {@code aroonosc_*}
...
public final class Aroonosc {
    ...
    /** FNV-1a32("aroonosc") == C_INDICATOR_ID_AROONOSC from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xf9bf1045L;

    static final Native NATIVE = new Native("aroonosc", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs AROONOSC over the given bars.
     *
