...
/**
 * OBV (On Balance Volume) — Java facade over the {@code obv_*}
...
public final class Obv {
    ...
    /** FNV-1a32("obv") == C_INDICATOR_ID_OBV from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xab451766L;

    static final Native NATIVE = new Native("obv", ID, INPUTS, OPTIONS);
