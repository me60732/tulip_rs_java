...
/**
 * DI (Directional Indicator) — Java facade over the {@code di_*}
...
public final class Di {
    ...
    /** FNV-1a32("di") == C_INDICATOR_ID_DI from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x601cd4eeL;

    static final Native NATIVE = new Native("di", ID, INPUTS, OPTIONS);
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional outputs: plus_dm, atr, tr. */
    ...
    /** As {@link #simdByOptions(double[][], double[][])} plus optional outputs: plus_dm, atr, tr. */
