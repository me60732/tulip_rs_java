...
/**
 * MIN (Minimum) — Java facade over the {@code min_*} tulip_rs_ffi symbols.
...
public final class Min {
    ...
    /** FNV-1a32("min") == C_INDICATOR_ID_MIN from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xc98f4557L;

    static final Native NATIVE = new Native("min", ID, INPUTS, OPTIONS);
     ...
     * outputs. MIN has no optional outputs.
     */
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional outputs (none for MIN). */
    ...
    /** As {@link #simdByOptions(double[][], double[][])} plus optional outputs (none for MIN). */
