...
/**
 * TRIMA (Triangular Moving Average) — Java facade over the {@code trima_*}
...
public final class Trima {
    ...
    /** FNV-1a32("trima") == C_INDICATOR_ID_TRIMA from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xc059e978L;

    static final Native NATIVE = new Native("trima", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs TRIMA over the given bars.
     *
    ...
    /** As {@link #simdByAssets(double[], double[])} — TRIMA has no optional outputs. */
    ...
    /** As {@link #simdByOptions(double[], double[][])} — TRIMA has no optional outputs. */
