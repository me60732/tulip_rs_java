...
/**
 * CCI (Commodity Channel Index) — Java facade over the {@code cci_*}
...
public final class Cci {
    ...
    /** FNV-1a32("cci") == C_INDICATOR_ID_CCI from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xed6fb77eL;

    static final Native NATIVE = new Native("cci", ID, INPUTS, OPTIONS);
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional outputs (sma, md, typprice). */
    ...
    /** As {@link #simdByOptions(double[], double[][])} plus optional outputs (sma, md, typprice). */
