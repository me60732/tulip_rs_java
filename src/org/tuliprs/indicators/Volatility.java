...
/**
 * VOLATILITY — Java facade over the {@code volatility_*}
...
public final class Volatility {
    ...
    /** FNV-1a32("volatility") == C_INDICATOR_ID_VOLATILITY from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xbe155b9aL;

    static final Native NATIVE = new Native("volatility", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs VOLATILITY over the given bars.
     *
     ...
     * outputs in fixed order: short_stddev, long_stddev.
     */
