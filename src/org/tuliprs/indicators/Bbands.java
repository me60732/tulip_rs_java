...
/**
 * Bollinger Bands — Java facade over the {@code bbands_*} tulip_rs_ffi
 * symbols. All work happens in the shared {@link Native} engine; this class
 * is just the indicator's constants plus delegation.
 *
 * <p>Outputs are three MANDATORY rows, in order: bbands_lower,
 * bbands_middle, bbands_upper (no optional outputs).
 *
...
public final class Bbands {
    ...
    /** Number of options: period, std_dev. */
    public static final int OPTIONS = 2;

    /** FNV-1a32("bbands") == C_INDICATOR_ID_BBANDS from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x88222d0fL;

    static final Native NATIVE = new Native("bbands", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Bollinger Bands over the given bars.
     *
     * @param inputs  {real}
     * @param options {period, std_dev}
     */
     ...
     * outputs (bbands has none — kept for surface symmetry; pass null/empty).
     */
