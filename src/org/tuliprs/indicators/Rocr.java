...
/**
 * ROCR (Rate of Change Ratio) — Java facade over the {@code rocr_*}
...
public final class Rocr {
    ...
    /** FNV-1a32("rocr") == C_INDICATOR_ID_ROCR from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x231b267fL;

    static final Native NATIVE = new Native("rocr", ID, INPUTS, OPTIONS);
