...
/**
 * CMO (Chande Momentum Oscillator) — Java facade over the {@code cmo_*}
...
public final class Cmo {
    ...
    /** FNV-1a32("cmo") == C_INDICATOR_ID_CMO from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xef924ce6L;

    static final Native NATIVE = new Native("cmo", ID, INPUTS, OPTIONS);
