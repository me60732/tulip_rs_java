...
/**
 * Keltnerchannel — Java facade over the {@code keltnerchannel_*} tulip_rs_ffi symbols.
 ...
 */
public final class Keltnerchannel {

    private Keltnerchannel() {}
    ...
    /** FNV-1a32("keltnerchannel") == C_INDICATOR_ID_KELTNERCHANNEL from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x35db4b2dL;

    static final Native NATIVE = new Native("keltnerchannel", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs KeltnerChannel over the given bars.
     *
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional outputs (atr, tr). */
    ...
    /** As {@link #simdByOptions(double[], double[][])} plus optional outputs (atr, tr). */
