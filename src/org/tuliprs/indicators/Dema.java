...
/**
 * DEMA (Double Exponential Moving Average) — Java facade over the {@code dema_*}
...
public final class Dema {
    ...
    /** FNV-1a32("dema") == C_INDICATOR_ID_DEMA from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xb8fd44f4L;

    static final Native NATIVE = new Native("dema", ID, INPUTS, OPTIONS);
