...
/**
 * ADX (Average Directional Index) — Java facade over the {@code adx_*}
...
public final class Adx {
    ...
    /** FNV-1a32("adx") == C_INDICATOR_ID_ADX from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x1f38e660L;

    static final Native NATIVE = new Native("adx", ID, INPUTS, OPTIONS);
     ...
     * outputs in fixed order: dx, atr, tr.
     */
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional outputs (dx, atr, tr). */
