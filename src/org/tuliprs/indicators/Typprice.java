...
/**
 * TYPPRICE (Typical Price) — Java facade over the {@code typprice_*}
 ...
 *
 * <p>Memory model: every {@link Outcome#result()} is a closeable owner of
 * zero-copy output views; every {@link State} is a closeable streaming handle.
 * Use try-with-resources; never call a free.
 */
public final class Typprice {
    ...
    /** FNV-1a32("typprice") == C_INDICATOR_ID_TYPPRICE from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xd6324b9bL;

    static final Native NATIVE = new Native("typprice", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs TYPPRICE over the given bars.
     *
