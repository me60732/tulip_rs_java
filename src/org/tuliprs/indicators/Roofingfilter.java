...
/**
 * RoofingFilter — Java facade over the {@code roofingfilter_*}
 ...
 */
public final class Roofingfilter {
    ...
    /** FNV-1a32("roofingfilter") == C_INDICATOR_ID_ROOFINGFILTER from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x7324db5bL;

    static final Native NATIVE = new Native("roofingfilter", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs RoofingFilter over the given bars.
     *
