...
/**
 * Super Smoother Filter — Java facade over the {@code supersmoother_*}
...
public final class Supersmoother {
    ...
    /** FNV-1a32("supersmoother") == C_INDICATOR_ID_SUPERSMOOTHER from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x5a9e8325L;

    static final Native NATIVE = new Native("supersmoother", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Super Smoother Filter over the given bars.
     *
