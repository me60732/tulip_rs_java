...
/**
 * Elderray (Elder Ray) — Java facade over the {@code elderray_*}
...
public final class Elderray {
    ...
    /** FNV-1a32("elderray") == C_INDICATOR_ID_ELDERRAY from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xeb756059L;

    static final Native NATIVE = new Native("elderray", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Elderray over the given bars.
     *
