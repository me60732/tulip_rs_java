...
/**
 * TRVI (Trend and Volume Index) — Java facade over the {@code trvi_*}
...
public final class Trvi {
    ...
    /** FNV-1a32("trvi") == C_INDICATOR_ID_TRVI from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x59afe632L;

    static final Native NATIVE = new Native("trvi", ID, INPUTS, OPTIONS);
