...
/**
 * Kama — Java facade over the {@code kama_*} tulip_rs_ffi symbols.
...
public final class Kama {
    ...
    /** FNV-1a32("kama") == C_INDICATOR_ID_KAMA from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x42cb218fL;

    static final Native NATIVE = new Native("kama", ID, INPUTS, OPTIONS);
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional output (ef). */
    ...
    /** As {@link #simdByOptions(double[], double[][])} plus optional output (ef). */
