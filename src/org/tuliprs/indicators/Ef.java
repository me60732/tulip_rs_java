...
/**
 * EF (Efficiency Ratio) — Java facade over the {@code ef_*}
...
public final class Ef {
    ...
    /** FNV-1a32("ef") == C_INDICATOR_ID_EF from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x391a58f2L;

    static final Native NATIVE = new Native("ef", ID, INPUTS, OPTIONS);
