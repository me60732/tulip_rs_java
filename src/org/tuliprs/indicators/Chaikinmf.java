...
/**
 * CHAIKINMF (Chaikin Money Flow) — Java facade over the {@code chaikinmf_*}
...
public final class Chaikinmf {
    ...
    /** FNV-1a32("chaikinmf") == C_INDICATOR_ID_CHAIKINMF from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x214268edL;

    static final Native NATIVE = new Native("chaikinmf", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs CHAIKINMF over the given bars.
     *
