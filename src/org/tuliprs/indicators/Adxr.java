...
/**
 * ADXR (Average Directional Index Rating) — Java facade over the {@code adxr_*}
...
public final class Adxr {
    ...
    /** FNV-1a32("adxr") == C_INDICATOR_ID_ADXR from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x38922e56L;

    static final Native NATIVE = new Native("adxr", ID, INPUTS, OPTIONS);
