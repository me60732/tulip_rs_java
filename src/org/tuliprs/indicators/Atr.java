...
/**
 * ATR (Average True Range) — Java facade over the {@code atr_*}
...
public final class Atr {
    ...
    /** FNV-1a32("atr") == C_INDICATOR_ID_ATR from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x2961988eL;

    static final Native NATIVE = new Native("atr", ID, INPUTS, OPTIONS);
