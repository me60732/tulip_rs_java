...
/**
 * VWAP (Volume Weighted Average Price) — Java facade over the {@code vwap_*}
...
public final class Vwap {
    ...
    /** FNV-1a32("vwap") == C_INDICATOR_ID_VWAP from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x8b807f03L;

    static final Native NATIVE = new Native("vwap", ID, INPUTS, OPTIONS);
