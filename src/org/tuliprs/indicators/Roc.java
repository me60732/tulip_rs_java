...
/**
 * ROC (Rate of Change) — Java facade over the {@code roc_*}
...
public final class Roc {
    ...
    /** FNV-1a32("roc") == C_INDICATOR_ID_ROC from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x380e0a97L;

    static final Native NATIVE = new Native("roc", ID, INPUTS, OPTIONS);
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional output (mom). */
