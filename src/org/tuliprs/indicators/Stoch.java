...
/**
 * Stoch (Stochastic Oscillator) — Java facade over the {@code stoch_*}
...
public final class Stoch {
    ...
    /** Number of options: k_period, k_slow_period, d_period. */
    public static final int OPTIONS = 3;

    /** FNV-1a32("stoch") == C_INDICATOR_ID_STOCH from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xbf0c7edcL;

    static final Native NATIVE = new Native("stoch", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Stochastic Oscillator over the given bars.
     *
     * @param inputs  {high, low, close}, each of equal length
     * @param options {k_period, k_slow_period, d_period}
     */
    ...
    /** As {@link #simdByOptions(double[], double[][])} plus optional outputs: none. */
