...
/**
 * WCPRICE (Weighted Close Price) — Java facade over the {@code wcprice_*}
...
public final class Wcprice {
    ...
    /** FNV-1a32("wcprice") == C_INDICATOR_ID_WCPRICE from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x1cee7768L;

    static final Native NATIVE = new Native("wcprice", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs WCPRICE over the given bars.
     *
