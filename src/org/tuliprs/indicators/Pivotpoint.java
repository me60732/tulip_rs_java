...
/**
 * Pivotpoint (Pivot Points) — Java facade over the {@code pivotpoint_*}
...
public final class Pivotpoint {
    ...
    /** FNV-1a32("pivotpoint") == C_INDICATOR_ID_PIVOTPOINT from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x4fe2b16fL;

    static final Native NATIVE = new Native("pivotpoint", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Pivotpoint over the given bars.
     *
     ...
     * outputs in fixed order: s3, s2, s1, pp, r1, r2, r3.
     */
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional outputs (s3,s2,s1,pp,r1,r2,r3). */
