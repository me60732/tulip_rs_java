...
/**
 * WMA (Weighted Moving Average) — Java facade over the {@code wma_*}
...
public final class Wma {
    ...
    /** FNV-1a32("wma") == C_INDICATOR_ID_WMA from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xfced2660L;

    static final Native NATIVE = new Native("wma", ID, INPUTS, OPTIONS);
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional outputs (sma). */
