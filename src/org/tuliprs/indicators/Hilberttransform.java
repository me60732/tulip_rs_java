...
/**
 * Hilberttransform — Java facade over the {@code hilberttransform_*}
...
public final class Hilberttransform {
    ...
    /** Number of options: ss_period, hp_period. */
    public static final int OPTIONS = 2;

    /** FNV-1a32("hilberttransform") == C_INDICATOR_ID_HILBERTTRANSFORM from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x18e2d9dfL;

    static final Native NATIVE = new Native("hilberttransform", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Hilberttransform over the given bars.
     *
     * @param inputs  {real}, of equal length
     * @param options {ss_period, hp_period}
     */
     ...
     * outputs in fixed order: roofing, highpass.
     */
