...
/**
 * MAMA (MESA Adaptive Moving Average) — Java facade over the {@code mama_*}
...
public final class Mama {
    ...
    /** Number of input series: real (close price). */
    public static final int INPUTS = 1;

    /** Number of options: fastlimit, slowlimit. */
    public static final int OPTIONS = 2;

    /** FNV-1a32("mama") == C_INDICATOR_ID_MAMA from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0xc19b2ed9L;

    static final Native NATIVE = new Native("mama", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs MAMA over the given bars.
     *
     * @param inputs  {real}, each of equal length
     * @param options {fastlimit, slowlimit}
     */
     ...
     * outputs in fixed order: dc_period, alpha.
     */
    ...
    /** As {@link #simdByAssets(double[], double[])} plus optional outputs (dc_period, alpha). */
