...
/**
 * NVI (Negative Volume Index) — Java facade over the {@code nvi_*}
...
public final class Nvi {
    ...
    /** FNV-1a32("nvi") == C_INDICATOR_ID_NVI from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x12791fc4L;

    static final Native NATIVE = new Native("nvi", ID, INPUTS, OPTIONS);
