...
/**
 * Fisher (Fisher Transform) — Java facade over the {@code fisher_*}
...
public final class Fisher {
    ...
    /** FNV-1a32("fisher") == C_INDICATOR_ID_FISHER from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x45855c00L;

    static final Native NATIVE = new Native("fisher", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Fisher Transform over the given bars.
     *
     ...
     * outputs in fixed order: fisher_signal.
     */
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional outputs (fisher_signal). */
    ...
    /** As {@link #simdByOptions(double[][], double[][])} plus optional outputs (fisher_signal). */
