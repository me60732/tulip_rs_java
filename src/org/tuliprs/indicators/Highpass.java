...
/**
 * Highpass — Java facade over the {@code highpass_*} tulip_rs_ffi symbols.
...
public final class Highpass {
    ...
    /** Number of options: period (from C HIGHPASS_OPTIONS=1). */
    public static final int OPTIONS = 1;

    /** FNV-1a32("highpass") == C_INDICATOR_ID_HIGHPASS from tulip_rs_ffi_state_ids.h. */
    public static final long ID = 0x32aa3ad0L;

    static final Native NATIVE = new Native("highpass", ID, INPUTS, OPTIONS);
    ...
    /**
     * Runs Highpass over the given bars.
     *
     * @param inputs  {real}, of equal length
     * @param options {period, cutoff}
     */
     ...
     * outputs in fixed order: in_phase, quadrature, roofing.
     */
    ...
    /** As {@link #simdByAssets(double[][][], double[])} plus optional outputs (in_phase, quadrature, roofing). */
