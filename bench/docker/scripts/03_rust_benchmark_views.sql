...
SELECT runs.id AS run_id,
    ...
    round(avg(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) AS vectorta_avg_mean_time_ns,
    ...
    count(DISTINCT CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.options ELSE NULL::jsonb END) AS vectorta_options_count,
    ...
    round((avg(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / avg(CASE WHEN ((results.implementation_type)::text = 'Rust'::text) THEN results.mean_time_ns ELSE NULL::bigint END)), 2) AS vectorta_to_rust_ratio,
    ...
    round((((avg(CASE WHEN ((results.implementation_type)::text = 'Rust'::text) THEN results.mean_time_ns ELSE NULL::bigint END) - avg(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) / avg(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) * (100)::numeric), 2) AS rust_vs_vectorta_percent_diff
 ...
 HAVING (count(DISTINCT CASE WHEN ((results.implementation_type)::text = ANY ((ARRAY['C_tulip'::character varying, 'Rust'::character varying, 'talib'::character varying, 'RustKanda'::character varying, 'RustTa'::character varying, 'VectorTa'::character varying])::text[])) THEN results.implementation_type ELSE NULL::character varying END) >= 2)
...
SELECT runs.id AS run_id,
    ...
    max(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END) AS vectorta_mean_time_ns,
    ...
    max(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.sample_count ELSE NULL::integer END) AS vectorta_sample_count,
    ...
    round(((max(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric / (max(CASE WHEN ((results.implementation_type)::text = 'Rust'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric), 2) AS vectorta_to_rust_ratio,
    ...
    round(((((max(CASE WHEN ((results.implementation_type)::text = 'Rust'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric - (max(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric) / (max(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric) * (100)::numeric), 2) AS rust_vs_vectorta_percent_diff
   FROM ((benchmark_runs runs
     JOIN benchmark_results results ON ((runs.id = results.run_id)))
     JOIN indicators ind ON ((results.indicator_id = ind.id)))
...
SELECT runs.id AS run_id,
    ...
    count(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN 1 ELSE NULL::integer END) AS vectorta_symbol_count,
    round((avg(CASE WHEN ((results.implementation_type)::text = 'C_tulip'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / avg(CASE WHEN ((results.implementation_type)::text = 'Rust'::text) THEN results.mean_time_ns ELSE NULL::bigint END)), 2) AS c_to_rust_ratio,
    round((((avg(CASE WHEN ((results.implementation_type)::text = 'Rust'::text) THEN results.mean_time_ns ELSE NULL::bigint END) - avg(CASE WHEN ((results.implementation_type)::text = 'C_tulip'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) / avg(CASE WHEN ((results.implementation_type)::text = 'C_tulip'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) * (100)::numeric), 2) AS rust_vs_c_percent_diff,
    round((avg(CASE WHEN ((results.implementation_type)::text = 'talib'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / avg(CASE WHEN ((results.implementation_type)::text = 'Rust'::text) THEN results.mean_time_ns ELSE NULL::bigint END)), 2) AS talib_to_rust_ratio,
    round((avg(CASE WHEN ((results.implementation_type)::text = 'RustKanda'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / avg(CASE WHEN ((results.implementation_type)::text = 'Rust'::text) THEN results.mean_time_ns ELSE NULL::bigint END)), 2) AS rustkanda_to_rust_ratio,
...
SELECT runs.id AS run_id,
    ...
    max(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END) AS rust_vector_ta_mean_time_ns,
    max(CASE WHEN ((results.implementation_type)::text = 'Rust'::text) THEN results.sample_count ELSE NULL::integer END) AS rust_sample_count,
    ...
    max(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.sample_count ELSE NULL::integer END) AS rust_vector_ta_sample_count
   FROM ((benchmark_runs runs
     JOIN benchmark_results results ON ((runs.id = results.run_id)))
     JOIN indicators ind ON ((results.indicator_id = ind.id)))
  WHERE ((ind.category)::text <> 'candlestick'::text)
...
SELECT runs.id AS run_id,
    ...
    count(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN 1 ELSE NULL::integer END) AS rust_vector_ta_symbol_count
   FROM ((benchmark_runs runs
     JOIN benchmark_results results ON ((runs.id = results.run_id)))
     JOIN indicators ind ON ((results.indicator_id = ind.id)))
  WHERE ((ind.category)::text <> 'candlestick'::text)
...
SELECT runs.id AS run_id,
    ...
    sum(CASE WHEN ((results.implementation_type)::text = 'talib'::text) THEN results.mean_time_ns ELSE NULL::bigint END) AS talib_total_mean_time_ns,
    sum(CASE WHEN ((results.implementation_type)::text = 'RustKanda'::text) THEN results.mean_time_ns ELSE NULL::bigint END) AS rustkanda_total_mean_time_ns,
    sum(CASE WHEN ((results.implementation_type)::text = 'RustTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END) AS rustta_total_mean_time_ns,
    sum(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END) AS vectorta_total_mean_time_ns,
    ...
    round(((NULLIF(sum(CASE WHEN ((results.implementation_type)::text = 'C_tulip'::text) THEN results.mean_time_ns ELSE NULL::bigint END), (0)::numeric) / max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) * (100)::numeric), 2) AS simd_vs_c_tulip_percent_improvement,
    round(((NULLIF(sum(CASE WHEN ((results.implementation_type)::text = 'talib'::text) THEN results.mean_time_ns ELSE NULL::bigint END), (0)::numeric) / max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) * (100)::numeric), 2) AS simd_vs_talib_percent_improvement,
    round(((NULLIF(sum(CASE WHEN ((results.implementation_type)::text = 'RustKanda'::text) THEN results.mean_time_ns ELSE NULL::bigint END), (0)::numeric) / max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) * (100)::numeric), 2) AS simd_vs_rustkanda_percent_improvement,
    round(((NULLIF(sum(CASE WHEN ((results.implementation_type)::text = 'RustTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END), (0)::numeric) / max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) * (100)::numeric), 2) AS simd_vs_rustta_percent_improvement,
    round(((NULLIF(sum(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END), (0)::numeric) / max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) * (100)::numeric), 2) AS simd_vs_vectorta_percent_improvement
   FROM ((benchmark_runs runs
     JOIN benchmark_results results ON ((runs.id = results.run_id)))
     JOIN indicators ind ON ((results.indicator_id = ind.id)))
  WHERE ((results.implementation_type)::text = ANY ((ARRAY['Rust'::character varying, 'C_tulip'::character varying, 'talib'::character varying, 'RustKanda'::character varying, 'RustTa'::character varying, 'VectorTa'::character varying, 'Rust_SIMD'::character varying])::text[]))
 ...
 HAVING ((max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END) IS NOT NULL) AND ((sum(CASE WHEN ((results.implementation_type)::text = 'Rust'::text) THEN 1 ELSE 0 END) > 0) OR (sum(CASE WHEN ((results.implementation_type)::text = 'C_tulip'::text) THEN 1 ELSE 0 END) > 0) OR (sum(CASE WHEN ((results.implementation_type)::text = 'talib'::text) THEN 1 ELSE 0 END) > 0) OR (sum(CASE WHEN ((results.implementation_type)::text = 'RustKanda'::text) THEN 1 ELSE 0 END) > 0) OR (sum(CASE WHEN ((results.implementation_type)::text = 'RustTa'::text) THEN 1 ELSE 0 END) > 0) OR (sum(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN 1 ELSE 0 END) > 0)))
  ORDER BY runs.run_timestamp DESC, ind.name, results.stock_symbol;
...
SELECT runs.id AS run_id,
    ...
    sum(CASE WHEN ((results.implementation_type)::text = 'RustTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END) AS rustta_total_mean_time_ns,
    sum(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END) AS vectorta_total_mean_time_ns,
    round((avg(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD_by_assets'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / NULLIF(sum(CASE WHEN ((results.implementation_type)::text = 'Rust'::text) THEN results.mean_time_ns ELSE NULL::bigint END), (0)::numeric)), 4) AS simd_asset_to_rust_ratio,
    round(((NULLIF(sum(CASE WHEN ((results.implementation_type)::text = 'Rust'::text) THEN results.mean_time_ns ELSE NULL::bigint END), (0)::numeric) / avg(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD_by_assets'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) * (100)::numeric), 2) AS simd_asset_vs_rust_percent_improvement,
    round(((NULLIF(sum(CASE WHEN ((results.implementation_type)::text = 'C_tulip'::text) THEN results.mean_time_ns ELSE NULL::bigint END), (0)::numeric) / avg(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD_by_assets'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) * (100)::numeric), 2) AS simd_asset_vs_c_tulip_percent_improvement,
    round(((NULLIF(sum(CASE WHEN ((results.implementation_type)::text = 'talib'::text) THEN results.mean_time_ns ELSE NULL::bigint END), (0)::numeric) / avg(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD_by_assets'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) * (100)::numeric), 2) AS simd_asset_vs_talib_percent_improvement,
    round(((NULLIF(sum(CASE WHEN ((results.implementation_type)::text = 'RustKanda'::text) THEN results.mean_time_ns ELSE NULL::bigint END), (0)::numeric) / avg(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD_by_assets'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) * (100)::numeric), 2) AS simd_asset_vs_rustkanda_percent_improvement,
    round(((NULLIF(sum(CASE WHEN ((results.implementation_type)::text = 'RustTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END), (0)::numeric) / avg(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD_by_assets'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) * (100)::numeric), 2) AS simd_asset_vs_rustta_percent_improvement,
    round(((NULLIF(sum(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END), (0)::numeric) / avg(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD_by_assets'::text) THEN results.mean_time_ns ELSE NULL::bigint END)) * (100)::numeric), 2) AS simd_asset_vs_vectorta_percent_improvement
   FROM ((benchmark_runs runs
     JOIN benchmark_results results ON ((runs.id = results.run_id)))
     JOIN indicators ind ON ((results.indicator_id = ind.id)))
  WHERE ((results.implementation_type)::text = ANY ((ARRAY['Rust'::character varying, 'C_tulip'::character varying, 'talib'::character varying, 'RustKanda'::character varying, 'RustTa'::character varying, 'VectorTa'::character varying, 'Rust_SIMD_by_assets'::character varying])::text[]))
  GROUP BY runs.id, runs.run_timestamp, runs.system_info, ind.name, results.options, results.data_source
 HAVING ((avg(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD_by_assets'::text) THEN results.mean_time_ns ELSE NULL::bigint END) IS NOT NULL) AND ((sum(CASE WHEN ((results.implementation_type)::text = 'Rust'::text) THEN 1 ELSE 0 END) > 0) OR (sum(CASE WHEN ((results.implementation_type)::text = 'C_tulip'::text) THEN 1 ELSE 0 END) > 0) OR (sum(CASE WHEN ((results.implementation_type)::text = 'talib'::text) THEN 1 ELSE 0 END) > 0) OR (sum(CASE WHEN ((results.implementation_type)::text = 'RustKanda'::text) THEN 1 ELSE 0 END) > 0) OR (sum(CASE WHEN ((results.implementation_type)::text = 'RustTa'::text) THEN 1 ELSE 0 END) > 0) OR (sum(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN 1 ELSE 0 END) > 0)))
...
SELECT runs.id AS run_id,
    ...
    count(CASE WHEN ((results.implementation_type)::text = 'talib'::text) THEN 1 ELSE NULL::integer END) AS talib_options_count,
    count(CASE WHEN ((results.implementation_type)::text = 'RustKanda'::text) THEN 1 ELSE NULL::integer END) AS rustkanda_options_count,
    count(CASE WHEN ((results.implementation_type)::text = 'RustTa'::text) THEN 1 ELSE NULL::integer END) AS rustta_options_count,
    count(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN 1 ELSE NULL::integer END) AS vectorta_options_count,
    ...
    round((sum(CASE WHEN ((results.implementation_type)::text = 'talib'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / (max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric), 4) AS talib_to_simd_ratio,
    round(((sum(CASE WHEN ((results.implementation_type)::text = 'talib'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / (max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric) * (100)::numeric), 2) AS simd_vs_talib_percent_improvement,
    round((sum(CASE WHEN ((results.implementation_type)::text = 'talib'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / (max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric), 2) AS simd_speedup_vs_talib,
    round((sum(CASE WHEN ((results.implementation_type)::text = 'RustKanda'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / (max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric), 4) AS rustkanda_to_simd_ratio,
    round(((sum(CASE WHEN ((results.implementation_type)::text = 'RustKanda'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / (max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric) * (100)::numeric), 2) AS simd_vs_rustkanda_percent_improvement,
    round((sum(CASE WHEN ((results.implementation_type)::text = 'RustKanda'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / (max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric), 2) AS simd_speedup_vs_rustkanda,
    round((sum(CASE WHEN ((results.implementation_type)::text = 'RustTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / (max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric), 4) AS rustta_to_simd_ratio,
    round(((sum(CASE WHEN ((results.implementation_type)::text = 'RustTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / (max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric) * (100)::numeric), 2) AS simd_vs_rustta_percent_improvement,
    round((sum(CASE WHEN ((results.implementation_type)::text = 'RustTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / (max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric), 2) AS simd_speedup_vs_rustta,
    round((sum(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / (max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric), 4) AS vectorta_to_simd_ratio,
    round(((sum(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / (max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric) * (100)::numeric), 2) AS simd_vs_vectorta_percent_improvement,
    round((sum(CASE WHEN ((results.implementation_type)::text = 'VectorTa'::text) THEN results.mean_time_ns ELSE NULL::bigint END) / (max(CASE WHEN ((results.implementation_type)::text = 'Rust_SIMD'::text) THEN results.mean_time_ns ELSE NULL::bigint END))::numeric), 2) AS simd_speedup_vs_vectorta
   FROM ((benchmark_runs runs
     JOIN benchmark_results results ON ((runs.id = results.run_id)))
     JOIN indicators ind ON ((results.indicator_id = ind.id)))
  WHERE ((results.implementation_type)::text = ANY ((ARRAY['Rust_SIMD'::character varying, 'C_tulip'::character varying, 'talib'::character varying, 'RustKanda'::character varying, 'RustTa'::character varying, 'VectorTa'::character varying])::text[]))
  GROUP BY runs.id, runs.run_timestamp, runs.system_info, ind.name, results.stock_symbol, results.data_source, results.input_size
...
SELECT current_run.run_id,
  ...
  current_run.vectorta_avg_mean_time_ns AS current_vectorta_avg_time_ns,
  ...
  prev_run.vectorta_avg_mean_time_ns AS prev_vectorta_avg_time_ns,
    ...
    round((((current_run.vectorta_avg_mean_time_ns - prev_run.vectorta_avg_mean_time_ns) / prev_run.vectorta_avg_mean_time_ns) * (100)::numeric), 2) AS vectorta_performance_change_pct,
...
SELECT current_run.run_id, current_run.benchmark_date, current_run.hostname, current_run.indicator_name,
  ...
  current_run.rust_vector_ta_avg_mean_time_ns AS current_rust_vector_ta_avg_time_ns,
  prev_run.rust_vector_ta_avg_mean_time_ns AS prev_rust_vector_ta_avg_time_ns,
  round((((current_run.rust_vector_ta_avg_mean_time_ns - prev_run.rust_vector_ta_avg_mean_time_ns) / prev_run.rust_vector_ta_avg_mean_time_ns) * (100)::numeric), 2) AS rust_vector_ta_performance_change_pct
   FROM (( SELECT rust_impl_avg_options_comparison.run_id, rust_impl_avg_options_comparison.benchmark_date, rust_impl_avg_options_comparison.hostname, rust_impl_avg_options_comparison.indicator_name, rust_impl_avg_options_comparison.rust_avg_mean_time_ns, rust_impl_avg_options_comparison.rust_fromstate_avg_mean_time_ns, rust_impl_avg_options_comparison.rust_optional_avg_mean_time_ns, rust_impl_avg_options_comparison.rust_fromstate_1_bar_avg_mean_time_ns, rust_impl_avg_options_comparison.rust_fromstate_1_bar_json_avg_mean_time_ns, rust_impl_avg_options_comparison.rust_kanda_avg_mean_time_ns, rust_impl_avg_options_comparison.rust_ta_avg_mean_time_ns, rust_impl_avg_options_comparison.rust_vector_ta_avg_mean_time_ns,
...
SELECT run_id, benchmark_date, hostname, indicator_name,
    round(avg(rust_simd_mean_time_ns)) AS rust_simd_avg_time_ns, input_size,
    ...
    round(avg(rustkanda_total_mean_time_ns)) AS rustkanda_avg_total_time_ns,
    round(avg(rustta_total_mean_time_ns)) AS rustta_avg_total_time_ns,
    round(avg(vectorta_total_mean_time_ns)) AS vectorta_avg_total_time_ns,
    ...
    round(avg(simd_vs_talib_percent_improvement), 2) AS avg_simd_vs_talib_improvement_pct,
    round(avg(simd_vs_rustkanda_percent_improvement), 2) AS avg_simd_vs_rustkanda_improvement_pct,
    round(avg(simd_vs_rustta_percent_improvement), 2) AS avg_simd_vs_rustta_improvement_pct,
    round(avg(simd_vs_vectorta_percent_improvement), 2) AS avg_simd_vs_vectorta_improvement_pct,
...
SELECT run_id, benchmark_date, hostname, indicator_name,
    round(avg(rust_simd_asset_mean_time_ns)) AS rust_simd_asset_avg_time_ns, data_source,
    round(avg(rust_total_mean_time_ns)) AS rust_avg_total_time_ns,
    round(avg(c_tulip_total_mean_time_ns)) AS c_tulip_avg_total_time_ns,
    round(avg(talib_total_mean_time_ns)) AS talib_avg_total_time_ns,
    round(avg(rustkanda_total_mean_time_ns)) AS rustkanda_avg_total_time_ns,
    ...
    round(avg(simd_asset_vs_rustkanda_percent_improvement), 2) AS avg_simd_asset_vs_rustkanda_improvement_pct,
    round(avg(simd_asset_vs_rustta_percent_improvement), 2) AS avg_simd_asset_vs_rustta_improvement_pct,
    round(avg(simd_asset_vs_vectorta_percent_improvement), 2) AS avg_simd_asset_vs_vectorta_improvement_pct
...
SELECT run_id, benchmark_date, hostname, indicator_name,
    ...
    avg(talib_options_count) AS talib_avg_options_count,
    count(CASE WHEN (talib_total_mean_time_ns IS NOT NULL) THEN 1 ELSE NULL::integer END) AS talib_stock_count,
    avg(rustkanda_options_count) AS rustkanda_avg_options_count,
    count(CASE WHEN (rustkanda_total_mean_time_ns IS NOT NULL) THEN 1 ELSE NULL::integer END) AS rustkanda_stock_count,
    avg(rustta_options_count) AS rustta_avg_options_count,
    count(CASE WHEN (rustta_total_mean_time_ns IS NOT NULL) THEN 1 ELSE NULL::integer END) AS rustta_stock_count,
    avg(vectorta_options_count) AS vectorta_avg_options_count,
    count(CASE WHEN (vectorta_total_mean_time_ns IS NOT NULL) THEN 1 ELSE NULL::integer END) AS vectorta_stock_count,
    ...
    round(avg(talib_to_simd_ratio), 4) AS avg_talib_to_simd_ratio,
    round(avg(simd_vs_talib_percent_improvement), 2) AS avg_simd_vs_talib_improvement_pct,
    round(avg(simd_speedup_vs_talib), 2) AS avg_simd_speedup_vs_talib,
    round(avg(rustkanda_to_simd_ratio), 4) AS avg_rustkanda_to_simd_ratio,
    round(avg(simd_vs_rustkanda_percent_improvement), 2) AS avg_simd_vs_rustkanda_improvement_pct,
    round(avg(simd_speedup_vs_rustkanda), 2) AS avg_simd_speedup_vs_rustkanda,
    round(avg(rustta_to_simd_ratio), 4) AS avg_rustta_to_simd_ratio,
    round(avg(simd_vs_rustta_percent_improvement), 2) AS avg_simd_vs_rustta_improvement_pct,
    round(avg(simd_speedup_vs_rustta), 2) AS avg_simd_speedup_vs_rustta,
    round(avg(vectorta_to_simd_ratio), 4) AS avg_vectorta_to_simd_ratio,
    round(avg(simd_vs_vectorta_percent_improvement), 2) AS avg_simd_vs_vectorta_improvement_pct,
    round(avg(simd_speedup_vs_vectorta), 2) AS avg_simd_speedup_vs_vectorta,
...
SELECT run_id, benchmark_date, hostname, indicator_name,
  ...
  current_rust_vector_ta_avg_time_ns,
  rust_vector_ta_performance_change_pct
...
SELECT run_id, benchmark_date, hostname, indicator_name,
  current_rust_avg_time_ns, current_c_avg_time_ns, current_talib_avg_time_ns, current_rustkanda_avg_time_ns, current_rustta_avg_time_ns, current_vectorta_avg_time_ns, current_c_to_rust_ratio,
    ...
    vectorta_performance_change_pct,
    vectorta_ratio_change_pct,
    ...
    CASE WHEN ((current_vectorta_avg_time_ns IS NOT NULL) AND (current_rust_avg_time_ns > current_vectorta_avg_time_ns)) THEN round((((current_rust_avg_time_ns - current_vectorta_avg_time_ns) / current_vectorta_avg_time_ns) * (100)::numeric), 2) ELSE NULL::numeric END AS rust_slower_than_vectorta_by_pct
  ...
  WHERE ((rn = 1) AND (((current_c_avg_time_ns IS NOT NULL) AND (current_rust_avg_time_ns > current_c_avg_time_ns)) OR ((current_talib_avg_time_ns IS NOT NULL) AND (current_rust_avg_time_ns > current_talib_avg_time_ns)) OR ((current_rustkanda_avg_time_ns IS NOT NULL) AND (current_rust_avg_time_ns > current_rustkanda_avg_time_ns)) OR ((current_rustta_avg_time_ns IS NOT NULL) AND (current_rust_avg_time_ns > current_rustta_avg_time_ns)) OR ((current_vectorta_avg_time_ns IS NOT NULL) AND (current_rust_avg_time_ns > current_vectorta_avg_time_ns))))
  ORDER BY hostname, indicator_name;
...
SELECT run_id, benchmark_date, hostname, indicator_name,
    ...
    round(avg(rustkanda_avg_total_time_ns)) AS rustkanda_overall_avg_time_ns,
    round(avg(rustta_avg_total_time_ns)) AS rustta_overall_avg_time_ns,
    round(avg(vectorta_avg_total_time_ns)) AS vectorta_overall_avg_time_ns,
    ...
    round(avg(avg_simd_vs_talib_improvement_pct), 2) AS overall_simd_vs_talib_improvement_pct,
    round(avg(avg_simd_vs_rustkanda_improvement_pct), 2) AS overall_simd_vs_rustkanda_improvement_pct,
    round(avg(avg_simd_vs_rustta_improvement_pct), 2) AS overall_simd_vs_rustta_improvement_pct,
    round(avg(avg_simd_vs_vectorta_improvement_pct), 2) AS overall_simd_vs_vectorta_improvement_pct,
...
SELECT run_id, benchmark_date, hostname, indicator_name,
    ...
    round(avg(avg_simd_asset_vs_rustkanda_improvement_pct), 2) AS overall_simd_asset_vs_rustkanda_improvement_pct,
    round(avg(avg_simd_asset_vs_rustta_improvement_pct), 2) AS overall_simd_asset_vs_rustta_improvement_pct,
    round(avg(avg_simd_asset_vs_vectorta_improvement_pct), 2) AS overall_simd_asset_vs_vectorta_improvement_pct
...
SELECT run_id, benchmark_date, hostname, indicator_name,
    ...
    round(avg(talib_avg_options_count)) AS talib_overall_avg_options,
    round(avg(rustkanda_avg_options_count)) AS rustkanda_overall_avg_options,
    round(avg(rustta_avg_options_count)) AS rustta_overall_avg_options,
    round(avg(vectorta_avg_options_count)) AS vectorta_overall_avg_options,
    ...
    round(avg(avg_talib_to_simd_ratio), 4) AS overall_talib_to_simd_ratio,
    round(avg(avg_simd_vs_talib_improvement_pct), 2) AS overall_simd_vs_talib_improvement_pct,
    round(avg(avg_simd_speedup_vs_talib), 2) AS overall_simd_speedup_vs_talib,
    round(avg(avg_rustkanda_to_simd_ratio), 4) AS overall_rustkanda_to_simd_ratio,
    round(avg(avg_simd_vs_rustkanda_improvement_pct), 2) AS overall_simd_vs_rustkanda_improvement_pct,
    round(avg(avg_simd_speedup_vs_rustkanda), 2) AS overall_simd_speedup_vs_rustkanda,
    round(avg(avg_rustta_to_simd_ratio), 4) AS overall_rustta_to_simd_ratio,
    round(avg(avg_simd_vs_rustta_improvement_pct), 2) AS overall_simd_vs_rustta_improvement_pct,
    round(avg(avg_simd_speedup_vs_rustta), 2) AS overall_simd_speedup_vs_rustta,
    round(avg(avg_vectorta_to_simd_ratio), 4) AS overall_vectorta_to_simd_ratio,
    round(avg(avg_simd_vs_vectorta_improvement_pct), 2) AS overall_simd_vs_vectorta_improvement_pct,
    round(avg(avg_simd_speedup_vs_vectorta), 2) AS overall_simd_speedup_vs_vectorta,
    ...
    sum(talib_stock_count) AS total_talib_measurements,
    sum(rustkanda_stock_count) AS total_rustkanda_measurements,
    sum(rustta_stock_count) AS total_rustta_measurements,
    sum(vectorta_stock_count) AS total_vectorta_measurements
...
SELECT current_run.run_id, current_run.benchmark_date, current_run.hostname, current_run.indicator_name,
    ...
    current_run.talib_overall_avg_time_ns AS current_talib_avg_time_ns,
    current_run.rustkanda_overall_avg_time_ns AS current_rustkanda_avg_time_ns,
    current_run.rustta_overall_avg_time_ns AS current_rustta_avg_time_ns,
    current_run.vectorta_overall_avg_time_ns AS current_vectorta_avg_time_ns,
    ...
    prev_run.talib_overall_avg_time_ns AS prev_talib_avg_time_ns,
    prev_run.rustkanda_overall_avg_time_ns AS prev_rustkanda_avg_time_ns,
    prev_run.rustta_overall_avg_time_ns AS prev_rustta_avg_time_ns,
    prev_run.vectorta_overall_avg_time_ns AS prev_vectorta_avg_time_ns,
    ...
    round((current_run.overall_simd_vs_talib_improvement_pct - prev_run.overall_simd_vs_talib_improvement_pct), 2) AS simd_vs_talib_improvement_change_pct,
    round((current_run.overall_simd_vs_rustkanda_improvement_pct - prev_run.overall_simd_vs_rustkanda_improvement_pct), 2) AS simd_vs_rustkanda_improvement_change_pct,
    round((current_run.overall_simd_vs_rustta_improvement_pct - prev_run.overall_simd_vs_rustta_improvement_pct), 2) AS simd_vs_rustta_improvement_change_pct,
    round((current_run.overall_simd_vs_vectorta_improvement_pct - prev_run.overall_simd_vs_vectorta_improvement_pct), 2) AS simd_vs_vectorta_improvement_change_pct,
    (EXTRACT(epoch FROM (current_run.benchmark_date - prev_run.benchmark_date)) / (86400)::numeric) AS days_between_runs
...
SELECT current_run.run_id, current_run.benchmark_date, current_run.hostname, current_run.indicator_name,
    ...
    round((current_run.overall_simd_asset_vs_rustkanda_improvement_pct - prev_run.overall_simd_asset_vs_rustkanda_improvement_pct), 2) AS simd_asset_vs_rustkanda_improvement_change_pct,
    round((current_run.overall_simd_asset_vs_rustta_improvement_pct - prev_run.overall_simd_asset_vs_rustta_improvement_pct), 2) AS simd_asset_vs_rustta_improvement_change_pct,
    round((current_run.overall_simd_asset_vs_vectorta_improvement_pct - prev_run.overall_simd_asset_vs_vectorta_improvement_pct), 2) AS simd_asset_vs_vectorta_improvement_change_pct,
    ...
    current_run.overall_simd_asset_vs_rustkanda_improvement_pct,
    current_run.overall_simd_asset_vs_rustta_improvement_pct,
    current_run.overall_simd_asset_vs_vectorta_improvement_pct
...
SELECT current_run.run_id, current_run.benchmark_date, current_run.hostname, current_run.indicator_name,
    ...
    round((((current_run.talib_overall_avg_time_ns - prev_run.talib_overall_avg_time_ns) / prev_run.talib_overall_avg_time_ns) * (100)::numeric), 2) AS talib_performance_change_pct,
    round((current_run.overall_simd_vs_talib_improvement_pct - prev_run.overall_simd_vs_talib_improvement_pct), 2) AS simd_vs_talib_improvement_change_pct,
    round((((current_run.rustkanda_overall_avg_time_ns - prev_run.rustkanda_overall_avg_time_ns) / prev_run.rustkanda_overall_avg_time_ns) * (100)::numeric), 2) AS rustkanda_performance_change_pct,
    round((current_run.overall_simd_vs_rustkanda_improvement_pct - prev_run.overall_simd_vs_rustkanda_improvement_pct), 2) AS simd_vs_rustkanda_improvement_change_pct,
    round((((current_run.rustta_overall_avg_time_ns - prev_run.rustta_overall_avg_time_ns) / prev_run.rustta_overall_avg_time_ns) * (100)::numeric), 2) AS rustta_performance_change_pct,
    round((current_run.overall_simd_vs_rustta_improvement_pct - prev_run.overall_simd_vs_rustta_improvement_pct), 2) AS simd_vs_rustta_improvement_change_pct,
    round((((current_run.vectorta_overall_avg_time_ns - prev_run.vectorta_overall_avg_time_ns) / prev_run.vectorta_overall_avg_time_ns) * (100)::numeric), 2) AS vectorta_performance_change_pct,
    round((current_run.overall_simd_vs_vectorta_improvement_pct - prev_run.overall_simd_vs_vectorta_improvement_pct), 2) AS simd_vs_vectorta_improvement_change_pct,
    (EXTRACT(epoch FROM (current_run.benchmark_date - prev_run.benchmark_date)) / (86400)::numeric) AS days_between_runs
